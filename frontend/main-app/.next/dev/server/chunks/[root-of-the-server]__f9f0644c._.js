...
const BrandRepository = {
    ...
    async updateProfile (userId, data) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$database$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].brandProfile.upsert({
            where: {
                userId
            },
            update: cleanData,
...
const BrandService = {
     ...
     */ async updateBrandProfile (userId, profileData) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$database$2f$repositories$2f$brand$2d$repository$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BrandRepository"].updateProfile(userId, profileData);
    },
    /**
...
"[project]/frontend/main-app/app/api/brand/campaigns/[id]/matches/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$campaign$2f$campaign$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CampaignService"].matchInfluencers(campaignId);
        } catch (matchError) {
            // If it's just "no influencers", we still want to return the campaign info
            if (matchError.message.includes('No influencers')) {
                const campaign = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$campaign$2f$campaign$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CampaignService"].getCampaignWithMatches(campaignId);
        ...
        const matches = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$campaign$2f$campaign$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CampaignService"].getCampaignWithMatches(campaignId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9f0644c._.js.map
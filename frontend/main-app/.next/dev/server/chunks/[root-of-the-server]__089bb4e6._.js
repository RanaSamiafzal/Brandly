...
"[project]/frontend/main-app/app/api/notifications/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        let notifications;
        if (search) {
            notifications = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$activity$2f$activity$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ActivityService"].searchActivities(decoded.userId, search);
        } else {
            const filterArg = filter === 'unread' ? 'unread' : filter === 'read' ? 'read' : null;
            notifications = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$activity$2f$activity$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ActivityService"].getUserActivities(decoded.userId, limit, filterArg);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__089bb4e6._.js.map
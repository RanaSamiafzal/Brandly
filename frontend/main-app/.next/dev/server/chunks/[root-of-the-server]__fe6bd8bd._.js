...
const BrandRepository = {
    ...
    async getAIRecommendations (brandId) {
        ...
        const topMatches = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$database$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].matchScore.findMany({
            where: {
                campaign: {
                    brandId
                }
...
const ActivityService = {
    async logActivity (data) {
        ...
        try {
            const { getIO } = await __turbopack_context__.A("[project]/backend/core/src/socket/socket-handler.js [app-route] (ecmascript, async loader)");
            const io = getIO();
            if (io) {
...
const BrandService = {
     ...
     */ async getAIRecommendations (brandId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$database$2f$repositories$2f$brand$2d$repository$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BrandRepository"].getAIRecommendations(brandId);
    },
    /**
...
"[project]/frontend/main-app/app/api/influencer/collaborations/[id]/tasks/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$collaboration$2f$collaboration$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CollaborationService"].getCollabTasks(requestId);
...
async function POST(req, { params }) {
    try {
        ...
        if (!data.title) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Title is required'
        }, {
            status: 400
        });
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$collaboration$2f$collaboration$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CollaborationService"].addCollabTask({
            requestId,
            title: data.title,
            description: data.description || '',
...
async function PATCH(req, { params }) {
    try {
        ...
        if (!taskId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$collaboration$2f$collaboration$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CollaborationService"].updateCollabTask(taskId, updateData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            task
        });
    } catch (error) {
...
async function DELETE(req, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$core$2f$src$2f$services$2f$collaboration$2f$collaboration$2d$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CollaborationService"].deleteCollabTask(taskId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fe6bd8bd._.js.map
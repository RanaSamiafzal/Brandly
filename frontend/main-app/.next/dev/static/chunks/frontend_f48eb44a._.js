...
function InfluencerNotificationsDropdown() {
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$shared$2f$store$2f$auth$2d$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "InfluencerNotificationsDropdown.useAuthStore[user]": (s)=>s.user
    }["InfluencerNotificationsDropdown.useAuthStore[user]"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InfluencerNotificationsDropdown.useEffect": ()=>{
            if (!user?.id) return;
            ...
            socket.on('new_activity', {
                "InfluencerNotificationsDropdown.useEffect": (activity)=>{
                    if (!muted) {
                        // Play sound
                        const audio = new Audio('https://assets.mixkit.co/active_storage/sfx/2869/2869-preview.mp3');
                        audio.volume = 0.5;
                        audio.play().catch({
                            "InfluencerNotificationsDropdown.useEffect": (e)=>console.log("Audio play blocked", e)
                        }["InfluencerNotificationsDropdown.useEffect"]);
                        // Show Popup
                        setLatestAlert(activity);
                        setTimeout({
                            "InfluencerNotificationsDropdown.useEffect": ()=>setLatestAlert(null)
                        }["InfluencerNotificationsDropdown.useEffect"], 1000);
                        setNotifications({
                            "InfluencerNotificationsDropdown.useEffect": (prev)=>[
                                    activity,
                                    ...prev
                                ].slice(0, 15)
                        }["InfluencerNotificationsDropdown.useEffect"]);
                        setUnreadCount({
                            "InfluencerNotificationsDropdown.useEffect": (prev)=>prev + 1
                        }["InfluencerNotificationsDropdown.useEffect"]);
                    }
                }
            }["InfluencerNotificationsDropdown.useEffect"]);
            return ({
                "InfluencerNotificationsDropdown.useEffect": ()=>socket.disconnect()
            })["InfluencerNotificationsDropdown.useEffect"];
        }
    }["InfluencerNotificationsDropdown.useEffect"], [
        user?.id,
...
_s(InfluencerNotificationsDropdown, "hVF0MwTRnlj8rc6vBKkYcRJobTg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$shared$2f$store$2f$auth$2d$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"]
    ];
});
...
//# sourceMappingURL=frontend_f48eb44a._.js.map
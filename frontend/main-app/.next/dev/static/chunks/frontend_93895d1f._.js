...
"[project]/frontend/main-app/app/(auth)/login/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$shared$2f$store$2f$auth$2d$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "LoginPage.useAuthStore[login]": (state)=>state.login
    }["LoginPage.useAuthStore[login]"]);
    const { isAuthenticated, role } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$shared$2f$store$2f$auth$2d$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
...
_s(LoginPage, "jfJTLb3uJ9JutJBhB6xzY9Jq0AE=", false, function() {
    return [
...
//# sourceMappingURL=frontend_93895d1f._.js.map
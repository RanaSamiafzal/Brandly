...
"[project]/frontend/main-app/app/(dashboard)/brand/collaborations/[id]/management/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BrandManagementPage() {
    ...
    const [collabInfo, setCollabInfo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandManagementPage.useEffect": ()=>{
            setMounted(true);
            fetchTasks();
            fetchCollabDetails();
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandManagementPage.useEffect": ()=>{
            ...
            __turbopack_context__.A("[project]/node_modules/socket.io-client/build/esm/index.js [app-client] (ecmascript, async loader)").then({
                "BrandManagementPage.useEffect": ({ io })=>{
                    ...
                    newSocket.on('task_updated', {
                        "BrandManagementPage.useEffect": (updatedTask)=>{
                            setTasks({
                                "BrandManagementPage.useEffect": (prev)=>prev.map({
                                        "BrandManagementPage.useEffect": (t)=>t.id === updatedTask.id ? {
                                                ...t,
                    ...
                    newSocket.on('new_activity', {
                        "BrandManagementPage.useEffect": (activity)=>{
                    ...
                    return ({
                        "BrandManagementPage.useEffect": ()=>newSocket.close()
                    })["BrandManagementPage.useEffect"];
                }
            }["BrandManagementPage.useEffect"]);
        }
        ...
        "BrandManagementPage.useEffect": ()=>{
            setStats({
                ...
                completed: tasks.filter({
                    "BrandManagementPage.useEffect": (t)=>t.status === "completed" || t.status === "COMPLETED"
                }["BrandManagementPage.useEffect"]).length
            });
        }
    }["BrandManagementPage.useEffect"], [
        tasks
                        ...
                        children: isLoading ? [
                            ...
                            columnNumber: 25
                                ...
                                children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: `px-2 py-0.5 rounded-lg text-[8px] font-black uppercase tracking-widest ${task.priority === "High" ? "bg-red-50 text-red-500" : "bg-blue-50 text-blue-500"}`,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "p-4 rounded-2xl hover:bg-white hover:shadow-md transition-all text-gray-300 hover:text-blue-600",
...
_s(BrandManagementPage, "FoDbcWMuyZhKxEm2OqLQrg6ThsY=", false, function() {
    return [
...
_c = BrandManagementPage;
var _c;
__turbopack_context__.k.register(_c, "BrandManagementPage");
...
//# sourceMappingURL=_12cb4ab1._.js.map
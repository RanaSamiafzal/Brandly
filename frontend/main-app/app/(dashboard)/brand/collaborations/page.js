...
export default function Collaborations() {
    ...
    const stats = [
        ...
        { label: "Active", value: campaigns.filter((c) => c.status === "Active").length.toString(), icon: CheckCircle2, color: "text-green-500", bg: "bg-green-50" },
    ...
    return (
        <div className="max-w-screen-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 px-4 md:px-12 pb-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Collaborations & Campaigns</h1>
                    <p className="text-gray-500 mt-1 text-lg">Manage all your active and pending influencer campaigns.</p>
                </div>
                                    ...
                                    <div className="flex items-start justify-between gap-4">
                                        <div className="min-w-0">
                                            <div className="flex flex-wrap items-center gap-2 mb-1">
                                                <span className={`text-xs font-bold px-2.5 py-0.5 rounded-full ${campaign.status === "Active" ? "bg-green-100 text-green-700" :

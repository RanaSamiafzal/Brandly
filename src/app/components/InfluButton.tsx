...
export type ButtonVariant = 'primary' | 'success' | 'danger' | 'warning' | 'secondary' | 'outline';
export type ButtonSize = 'sm' | 'md' | 'lg';

interface InfluButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
